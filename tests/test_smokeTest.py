...
class TestSmokeTest():
  ...
  def test_join(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Natnael")
    self.driver.find_element(By.NAME, "lname").send_keys("Gashaw")
    self.driver.find_element(By.NAME, "bizname").send_keys("TNT")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Software")
